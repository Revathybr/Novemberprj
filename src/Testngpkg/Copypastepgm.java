...
public class Copypastepgm {
	...
	@Test
	public void copypastemtd()
	{
		WebElement fullname=driver.findElement(By.xpath("//*[@id=\"tblcrtac\"]/tbody/tr[3]/td[3]/input"));
		WebElement rediffid=driver.findElement(By.xpath("//*[@id=\"tblcrtac\"]/tbody/tr[7]/td[3]/input[1]"));
		WebElement emailaddress=driver.findElement(By.xpath("//*[@id=\"div_altemail\"]/table/tbody/tr[1]/td[3]/input"));
		fullname.sendKeys("revathy");
		...
		act.keyDown(emailaddress,Keys.CONTROL).sendKeys("v").keyUp(Keys.CONTROL);
		act.perform();
